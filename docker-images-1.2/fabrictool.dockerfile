...
# Install fabric-ca
RUN cd $GOPATH/src/github.com/hyperledger \
    && wget https://github.com/deevotech/fabric-ca/archive/release-1.2-deevo.zip \
    && unzip release-1.2-deevo.zip \
    && rm release-1.2-deevo.zip \
...
RUN cd $GOPATH/src/github.com/hyperledger \
    && wget https://github.com/hyperledger/fabric-samples/archive/release-1.2.zip \
    && unzip release-1.2.zip \
    && rm release-1.2.zip \
    && mv fabric-samples-release-1.2 fabric-samples 
